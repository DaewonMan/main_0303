...
public class SMain {
	public static void main(String[] args) {
		...
		try {
			ss = new ServerSocket(1111); // 각자 ip 맞는 포트번호
			System.out.println("대기중");
			Socket s = ss.accept(); // 클라이언트 받아들임
			System.out.println("상대방이 접속 하였습니다!");
